...
public struct CreateUserInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, name: String, surname: String, owner: String? = nil, codeList: [CodeLanguagesInput?]? = nil) {
    graphQLMap = ["id": id, "name": name, "surname": surname, "owner": owner, "codeList": codeList]
  }
  ...
  public var codeList: [CodeLanguagesInput?]? {
    get {
      return graphQLMap["codeList"] as! [CodeLanguagesInput?]?
    }
    set {
      graphQLMap.updateValue(newValue, forKey: "codeList")
    }
  }
}

public struct CodeLanguagesInput: GraphQLMapConvertible {
  public var graphQLMap: GraphQLMap

  public init(id: GraphQLID, type: String) {
...
public struct UpdateUserInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, name: String? = nil, surname: String? = nil, owner: String? = nil, codeList: [CodeLanguagesInput?]? = nil) {
    graphQLMap = ["id": id, "name": name, "surname": surname, "owner": owner, "codeList": codeList]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateUser: GraphQLSelectionSet {
      ...
      public struct CodeList: GraphQLSelectionSet {
        ...
        public init(id: GraphQLID, type: String) {
          self.init(snapshot: ["__typename": "codeLanguages", "id": id, "type": type])
        }
